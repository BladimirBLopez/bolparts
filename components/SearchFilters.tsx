              ...
              <div className="flex-1 overflow-y-auto px-5 py-4">
                ...
                <div className="mt-2 flex gap-2">
                  <select
                    ...
                    className="flex-1 rounded-xl border border-[#E4E4E1] bg-white px-3 py-2.5 text-sm text-[#16181D] outline-none"
                  >
                  ...
                  <select
                    ...
                    disabled={!marca}
                    className="flex-1 rounded-xl border border-[#E4E4E1] bg-white px-3 py-2.5 text-sm text-[#16181D] outline-none disabled:opacity-50"
                  >
                ...
                <select
                  ...
                  className="mt-2 w-full rounded-xl border border-[#E4E4E1] bg-white px-3 py-2.5 text-sm text-[#16181D] outline-none"
                >
